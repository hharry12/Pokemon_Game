...
class Window(Canvas):
    ...
    def __init__(self, master):
        ...
        self.text = StringVar()
        self.text.set("Professor: Hello and welcome to the world of pokemon, I am the mandatory Professor! What is your name?")
    ...
    # Method to change number of buttons
    def buttons_func(self, create, destroy):
        ...
        # Next create new buttons
        if create == 1:
            self.button1 = Button(self.master, textvariable = self.button1_text, command = partial(self.next_action, 1))
            self.button1.pack()
            ...
            self.button2 = Button(self.master, textvariable = self.button2_text, command = partial(self.next_action, 2))
            self.button2.pack()
            ...
            self.button3 = Button(self.master, textvariable = self.button3_text, command = partial(self.next_action, 3))
            self.button3.pack()
        else:
            pass
    ...
    def next_action(self, button_no):
        ...
        if scenario == "Initialise":
            ...
            self.player = tr.Trainer(self.name, [self.starter_choice], [5], [self.starter_type], 1, 0)
            self.professor = tr.Trainer("Professor", [self.professor_starter], [5], [self.professor_type], 0, 0)
    ...
    def get_name(self, button_no): # ****NEEDS UPDATE**** - Cannot input actual name, just uses default Red or Blue
        if button_no == 1:
            self.name = "Red"
        elif button_no == 2:
            self.name = "Blue"
        self.change_text("Professor: " + self.name + " Great name! I have three pokemon for you to choose from. Type 'a' for a Charmander, 'b' for a Squirtle or 'c' for a Bulbasaur!")
